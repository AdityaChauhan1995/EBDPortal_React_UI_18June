	...
	render() {
		...
		return (
			<Container fluid style={{justifyContent: 'center', alignItems: 'center'}}>
				...
				{(this.props.orderSubmissionFailed) &&
					<React.Fragment>
						...
						<Header as='h4' textAlign='center' style={{paddingTop: 0, paddingBottom: 20, marginTop: 0, fontWeight: 'normal', color: '#4E4E4E', opacity: 0.7}}>
							We have encountered some error while submitting order, try to raise order again
						</Header>
					</React.Fragment>
				}
				{(!this.props.orderSubmissionFailed) &&
					<React.Fragment>
						...
						<Header as='h4' textAlign='center' style={{paddingTop: 0, paddingBottom: 20, marginTop: 0, fontWeight: 'normal', color: '#4E4E4E', opacity: 0.7}}>
							Your order has been successfully submitted. We will notify you on your provided contact details about the status of your order.
						</Header>
...
const mapStateToProps = (state) => {
	return {
		...
		orderSubmissionFailed:state.order.data.orderSubmissionFailed
	}
}
