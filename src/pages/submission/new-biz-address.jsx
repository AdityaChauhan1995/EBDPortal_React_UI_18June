    ...
    render() {
        ...
        return (
            <Modal dimmer={dimmer}
                ...
                {
                    (this.props.mode !== 'Approval' && this.props.mode !== 'View' && this.props.instMessage.status === 'FAILURE') &&
                ...
                {
                    (this.props.mode !== 'Approval' && this.props.mode !== 'View' && this.props.instMessage.status === 'SUCCESS') &&
                ...
                <Modal.Content >
                    <Grid>
                        <AddressInstallation
                            data={this.state.installationAddress}
                            postCodes={[]}
                ...
                <Modal.Actions>
                    {(this.props.mode !== 'Approval' && this.props.mode !== 'View') && 
