...
class CompanyInformation extends Component {
	constructor(props) {
		...
		this.state = {
			nextUrl: url.substring(0, url.lastIndexOf("/")) + "/address-contact-details?mode=Approval",
	...
	downloadFile(item) {
		...
		console.log('externalOrderId',this.props.registrationDetails.externalOrderId )
