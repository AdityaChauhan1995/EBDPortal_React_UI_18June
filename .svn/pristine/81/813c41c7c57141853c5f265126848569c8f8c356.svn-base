...
class FundOverride extends Component {
	...
	show(deviceFund){
		this.setState({deviceFund, overrideFund:'', open: true })
	}
	close = () => {
		  ...
		  )
		{
			...
			this.setState({ open: false,status: 'DEFAULT' })
		}
		else{
	          ...
	          <Modal.Content style={{minHeight: 100}}>
	          			...
	          			<Grid>
	          				...
	          				<Grid.Row>
	          					...
	          					<Grid.Column width='8'>
	          						<Input  placeholder='Enter Amount' value={overrideFund} name='overrideFund' onChange={this.handleChange} />
	          					</Grid.Column>
	          				</Grid.Row>
	          			</Grid>
	          </Modal.Content>
